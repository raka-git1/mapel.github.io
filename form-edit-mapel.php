...
<form action="proses-edit-mapel.php" method="POST">
    ...
    <input type="text"
           name="nama_pelajaran"
           value="<?= htmlspecialchars($mapel['nama_pelajaran']) ?>"
           required>
    ...
    <input type="text"
           name="kode_pelajaran"
           value="<?= htmlspecialchars($mapel['kode_pelajaran']) ?>"
           required>
    ...
    <input type="text"
           name="guru"
           value="<?= htmlspecialchars($mapel['guru']) ?>"
           required>
    ...
    <input type="text"
           name="kelas"
           value="<?= htmlspecialchars($mapel['kelas']) ?>"
           required>
